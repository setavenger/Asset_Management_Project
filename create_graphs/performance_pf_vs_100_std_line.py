...
fig, axs = plt.subplots(2, 1, figsize=(12, 12), dpi=300, gridspec_kw={'height_ratios': [5, 2]})
...
ax2.plot(t, std_pf, label='$\u03C3^2$ Portfolio trailing 12 months', color=colors[1])
ax2.plot(t, std_bench, label='$\u03C3^2$ Benchmark trailing 12 months', color=colors[3])
...
plt.savefig('graphs_presentation_arial_narrow/performance_overview_bench_std_line.eps', dpi=300)
# plt.savefig('graphs/performance_overview_bench_std_line.png', dpi=300)
# plt.savefig('graphs/performance_overview_bench_std_line.pdf', dpi=300)
